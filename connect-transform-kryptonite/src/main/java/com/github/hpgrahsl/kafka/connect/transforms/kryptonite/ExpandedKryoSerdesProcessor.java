...
public class ExpandedKryoSerdesProcessor implements ExpandedSerdesProcessor {

  public ExpandedKryoSerdesProcessor() {}
  ...
  public <T> T undoTheThing(String encodedField, Class<T> type ){
    ...
    var encryptedField = KryoInstance.get().readObject(new Input(decodedField), type);
